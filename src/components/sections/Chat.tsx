      ...
      if (messages[0].type === "MESSAGE") {
        ...
        toast.info(
          <div className="flex gap-1 self-center italic">
            <div className="max-w-[10ch] truncate font-bold text-self">{messages[0].playerName}</div>
            ...
            {messages.map((message, index) =>
              message.type === "NOTIFICATION" ? (
                <div key={index} className="flex gap-1 self-center italic">
                  <div className="max-w-[10ch] truncate font-bold text-self">{message.playerName}</div>
